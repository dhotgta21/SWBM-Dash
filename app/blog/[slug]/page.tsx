...
// Single advice / blog article page.

import type { Metadata } from 'next'
import { notFound } from 'next/navigation'
import { getArticle, listArticles } from '@/lib/articles/loader'
...
export default async function ArticlePage({ params }: PageProps) {
  ...
  const blocks: unknown[] = [
    await blogPostingJsonLd(post),
    await breadcrumbJsonLd(post),
  ]
        ...
        <div className="lg:col-span-9">
          ...
          <div className="mb-8 max-w-3xl">
            ...
            <p className="mt-3 text-xs text-muted-foreground">
              {minutes} min read · Published {formatDate(post.date)}
            </p>
          </div>
...
// Re-export so other modules can pull the full article list when needed.
export { listArticles }
